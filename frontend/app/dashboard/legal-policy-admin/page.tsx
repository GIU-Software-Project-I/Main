...
export default function LegalPolicyAdminPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Legal & Policy Admin Dashboard</h1>
        <p className="text-muted-foreground mt-2">Legal rules and compliance management</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-card rounded-lg border border-border shadow-sm p-6">
          ...
          <p className="text-2xl font-bold text-green-600 dark:text-green-400 mt-2">98%</p>
        </div>
        <div className="bg-card rounded-lg border border-border shadow-sm p-6">
          <p className="text-muted-foreground text-sm">Violations</p>
      ...
      <div className="bg-card rounded-lg border border-border shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button className="p-4 border border-border rounded-lg hover:border-primary/50 hover:bg-accent transition-colors text-center">
            ...
            <p className="font-medium text-foreground">Legal Rules</p>
          </button>
          <button className="p-4 border border-border rounded-lg hover:border-primary/50 hover:bg-accent transition-colors text-center">
            <div className="text-2xl mb-2">📊</div>

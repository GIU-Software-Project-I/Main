...
export default function TeamBalancesPage() {
  ...
  const getLeaveTypeColor = (typeName: string) => {
    ...
    if (name.includes('annual')) return { bg: 'bg-blue-100', text: 'text-blue-700', bar: 'bg-blue-500' };
    if (name.includes('sick')) return { bg: 'bg-red-100', text: 'text-red-700', bar: 'bg-red-500' };
    if (name.includes('personal')) return { bg: 'bg-purple-100', text: 'text-purple-700', bar: 'bg-purple-500' };
    if (name.includes('maternity') || name.includes('paternity')) return { bg: 'bg-pink-100', text: 'text-pink-700', bar: 'bg-pink-500' };
    if (name.includes('unpaid')) return { bg: 'bg-orange-100', text: 'text-orange-700', bar: 'bg-orange-500' };
    ...
    return (
      <div className="p-6 lg:p-8 flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-1">Please log in to view team balances</p>
          <Link href="/login" className="mt-4 inline-block text-blue-600 hover:text-blue-700 font-medium">
            Go to Login
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
              <Link href="/dashboard/department-head" className="hover:text-gray-700">
                Dashboard
              </Link>
              <span>/</span>
              <span className="text-gray-900">Team Balances</span>
            </div>
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Team Leave Balances</h1>
            <div className="flex items-center gap-3 mt-1">
              <p className="text-gray-500">View your team members&apos; leave balances and upcoming leaves</p>
              {lastUpdated && (
          ...
          <button
            ...
            disabled={refreshing}
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-amber-600 mt-1">{onLeaveToday}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600 mt-1">{upcomingThisWeek}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Leave Days (7 days)</p>
                <p className="text-3xl font-bold text-purple-600 mt-1">{totalDaysOnLeaveThisWeek}</p>
              </div>
                  ...
                  <div key={member.employeeId} className="p-6">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">ID: {(member.employeeId || '').slice(-8)}</p>
                      </div>
                    </div>
                        ...
                        return (
                          <div key={balance.leaveTypeId} className={`p-4 rounded-lg ${colors.bg}`}>
                            ...
                            <div className="flex items-baseline gap-1">
                              ...
                              <span className="text-sm text-gray-500">/ {totalEntitled} days</span>
                            </div>
                            ...
                            <p className="text-xs text-gray-600 mt-1">Used: {balance.taken} days</p>
                          </div>
                        );
                      })}
                    </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            {filteredUpcomingLeaves.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900">No upcoming leaves</h3>
                <p className="text-gray-500 mt-1">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Managing Team Leave</h3>
              <ul className="mt-2 text-sm text-gray-600 space-y-1">
                <li>• <strong>Leave Balances:</strong> View remaining leave days for each team member</li>
                <li>• <strong>Upcoming Leaves:</strong> Plan workloads around scheduled absences</li>
                <li>• <strong>Pending</strong> indicates leave requests awaiting HR approval</li>
